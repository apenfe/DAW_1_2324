package laberintoMio; /* SE PONE PARA INDICAR EN QUE CARPETA ESTÁ, SI ES EN LA CARPETA PRINCIPAL NO HACE FALTA */
...
public class Input {
	...
	private static final String GENERIC_ERROR = "Algo ocurrió.";
